#!/bin/bash
# QYNO Masternode Setup Script V1.0 for Ubuntu 16.04 LTS
#
...
FOLDER=DAPS-MN-setup
#official name
NAME='Dapscoin'
#name2 in script such as line 49 & copy binaries to bin not used for all coins - make sure these match the coin 
NAME2=dapscoin
TICKER=DAPS
HIDDEN=.dapscoin
CONF=dapscoin.conf
...
CLI=dapscoin-cli
MONITOR=dapsmon.sh
SOURCE='https://github.com/DAPSCoin/DAPSCoin/releases/download/1.0.4/master_linux-v1.0.4.6.zip'
ARCHIVE=master_linux-v1.0.4.6.zip
FOLDER2=master_linux-v1.0.4.6/
